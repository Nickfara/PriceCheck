...
class dialog_cart():
        ...
        def content():
            ...
            for shop in ['Матушка', 'Алма', 'METRO']:
                scroll_layout_dialog = BoxLayout(orientation='vertical', spacing=0, padding=(0, 10, 0, 0),
                                                 adaptive_height=True, md_bg_color='gray')
                        ...
                        if item in cart_get:
                            ...
                            if item['seller'] == 'METRO':
                                ...
                                cart_plus = IconButton(text=' ', icon='cart-plus', id=str(item) + 'cart',
                                                       ...
                                                       icon_color='blue', line_color='white')
                        item_layout = BoxLayout(orientation='horizontal', size_hint_y=None, height='40dp', spacing=2, md_bg_color='white')
    ...
    def dialog_editCart_open(self):  # Открытие корзины
        ...
        copy_cart_dismiss = IconButton(icon='backburger', on_release=self.dialog_cart_open, icon_color='red',
